...
namespace SpringJavaEquivalent.Tests
{
    ...
    public class AuthorizationIntegrationTests : IClassFixture<WebApplicationFactory<Program>>
    {
        ...
        public AuthorizationIntegrationTests(WebApplicationFactory<Program> factory)
        {
            ...
            this.this.client = this.this.factory.CreateClient();
        }
        ...
        {
            // Act
            var response = await this.this.client.GetAsync("/api/v1/enhanced-test/public");
        ...
        {
            // Act
            var response = await this.this.client.GetAsync("/api/v1/enhanced-test/authenticated");
        ...
        {
            // Arrange
            var jwtService = this.this.factory.Services.GetRequiredService<JwtService>();
            var token = jwtService.GenerateToken("testuser", new[] { "USER" }, new[] { "CACHE_READ" });

            this.this.client.DefaultRequestHeaders.Authorization =
        ...
        public async Task AdminEndpoint_ShouldReturnForbidden_WithUserRole()
        {
            ...
            // Act
            var response = await this.this.client.GetAsync("/api/v1/enhanced-test/admin-role");
        ...
        public async Task CacheReadEndpoint_ShouldReturnOk_WithReadPermission()
        {
            ...
            // Act
            var response = await this.this.client.GetAsync("/api/v1/enhanced-test/cache-read");
        ...
        public async Task CacheWriteEndpoint_ShouldReturnForbidden_WithoutWritePermission()
        {
            ...
            // Act
            var response = await this.this.client.GetAsync("/api/v1/enhanced-test/cache-write");
        ...
        public async Task AuthLevelEndpoint_ShouldReturnOk_WithAAL2()
        {
            ...
            // Act
            var response = await this.this.client.GetAsync("/api/v1/enhanced-test/auth-level");
        ...
        public async Task IdentityProviderEndpoint_ShouldReturnOk_WithEnterpriseProvider()
        {
            ...
            // Act
            var response = await this.this.client.GetAsync("/api/v1/enhanced-test/identity-provider");
        ...
        public async Task MaximumSecurityEndpoint_ShouldReturnOk_WithAllRequirements()
        {
            ...
            // Act
            var response = await this.this.client.GetAsync("/api/v1/enhanced-test/maximum-security");
